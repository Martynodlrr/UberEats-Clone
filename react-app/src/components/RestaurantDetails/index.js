                        ...
                        return <div className='item-row'>
                            {
                                arr.map((item) => {
                                    return <div className='item-card'>
                                        <div>
                                            {cart && Object.values(cart).length && Object.values(cart)[0].restaurant_id !== restaurant.id && Object.values(cart).length >= 2  && user && restaurant && user.id !== restaurant.user_id ?
                                                <OpenModalButton
