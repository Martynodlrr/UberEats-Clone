...
from app.api import shopping_cart_routes, restaurant_routes, review_routes, user_routes, auth_routes
...
# app.register_blueprint(menu_items_routes, url_prefix='/api/menu-items')
